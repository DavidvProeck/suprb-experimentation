...
from suprb.optimizer.rule.nsga2.nsga2_novelty_G_P import NSGA2Novelty_G_P
...
def make_experiment_dir():
    ...
    exp_dir = project_root / f"RD_NSGA2_Novelty_Mutation_Variants_{tstamp}"
...
def run():
    ...
    for mut_name, mut in mutation_variants.items():
        ...
        subtitle = " - Novelty-Mode: " + str(rule_discovery.novelty_mode) + " - "+ mut_name + " Mutation"
