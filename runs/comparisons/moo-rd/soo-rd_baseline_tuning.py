...
def run(problem: str, job_id: str, rule_amount: int, filter_subpopulation: str,
    ...
    def suprb_ES_GA_space(trial: Trial, params: Bunch):
        ...
        params.rule_discovery__lmbda = trial.suggest_int('rule_discovery__lmbda', 10, 30)
        params.rule_discovery__n_iter = trial.suggest_int('rule_discovery__n_iter', 500, 1500)
        # GA is fixed
    ...
    experiment_name = f'ES-Baseline-tuning j:{job_id} p:{problem}; r:{rule_amount}; f:{filter_subpopulation}; -e:{experience_calculation}' or study_name
